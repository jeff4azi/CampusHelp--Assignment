  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M20.25 14.15v4.073a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25V14.15M15.75 7.5V6a2.25 2.25 0 00-2.25-2.25h-3A2.25 2.25 0 008.25 6v1.5M3.75 10.5h16.5"
      />
    </svg>
  );
}

export function HandshakeIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ClockIcon({ className = "w-3.5 h-3.5" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CurrencyIcon({ className = "w-3.5 h-3.5" }) {
  return (
    <svg
      className={className}
      fill="none"
